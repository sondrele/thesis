...
A subsection of the heap is shown with address \mem{0} being the address of the first object allocated to normalize for the comparison, the subsection is 4KB.
