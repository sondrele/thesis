...
Because our project targets an ARM processor architecture, we have to conditionally compile the libraries (like \lib{alloc} and \lib{collections}) that has functionality that we want to utilize, for this architecture.
