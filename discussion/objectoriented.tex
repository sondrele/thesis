...
\lib{zinc.rs} provides a macro called \code{platform\_tree} which takes an specification of the \glspl{mmio} used in the application and generates objects to operate on them.
