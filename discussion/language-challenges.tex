...
\item [LC5 Heap allocation] \hfill \\
  ...
  The allocation algorithm is directly dependent on the \lib{newlib} \func{malloc} implementation, and therefore the memory fragmentation should be equal to that of the existing {\C} platform.
