...
The executable program, called \prog{blinky}, blinks the LEDs on the STK.
...
The build system was then was modified to include the \gls{rcl} library by building it manually for the architecture producing a \file{libcore.rlib} library file which was linked to the \file{blinky.rs} file before compiling it to assembly.
...
At this stage of the evolution of the build system the {\emlib} bindings was build as part of the {\rust} application code.
