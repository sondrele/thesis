...
Notice how the responsibility of handling the ownership is transferred from the compiler the to programmer in the {\unsafe} block in the \code{register} function.
