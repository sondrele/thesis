...
In \autoref{lst:impl:cpp:static-constructor} the \code{Foo} constructor call must be issued before the main function is executed.
...
Let us first look at the standard version given in \autoref{lst:rust-hello-world}, we can see that all we have to define is the \code{main} function.
...
\code{extern "C"} makes this possible by making the function use the {\C} \gls{abi}.
