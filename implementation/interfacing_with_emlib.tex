...
This is a working example of one of {\rust}'s many zero-cost abstractions, enabled through the interoptability with {\C} \gls{abi} and exploiting features given by LLVM.
