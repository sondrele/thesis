...
We have written many example applications in {\rust} that utilizes the bindings for many of the {\gecko}'s peripherals, these examples have been a driving factor for defining new bindings.
