...
When we first set out to make the bindings for {\emlib}, our priority was to define a viable platform for writing rust applications, which we could use to evaluate the language on the embedded system.
...
\prog{adc}     &
The \gls{adc} was needed by the {\prog{sensor-tracker}}, and has been used to get the internal temperature of the \gls{cpu}. \\
...
\prog{i2c}  &
This driver is used by the {\prog{sensor-tracker}} application.
