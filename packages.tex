...
\newminted{rust}{autogobble,linenos,frame=lines}
\newminted{c}{autogobble,linenos,frame=lines}
\newminted{java}{autogobble,linenos,frame=lines}
\newminted{ca65}{autogobble,linenos,frame=lines}
...
% Possibly add this line to make the code listings smaller
% \usepackage{etoolbox}
