...
Access to these variables must be marked as \concept{volatile} (\textbf{LC1}) to make sure the compiler genereates code to reread the value in case it was updated.
