...
The platform evolved continouosly during the development phase.
...
In this dicussion, we look at the viability of using {\rust} in an embedded system and present the thoughts we had, and the experiences we made, during the work for this thesis.
