...
In a car, one finds embedded computers that are controlling the breaks of the car, the automatic windows, and navigation and entertainment systems.
...
\autoref{fig:vdc:langs} shows a VDC Research \cite{web:vdc} survey over language used in embedded systems.
According to the survey the usage of C and assembly are on the way down in favor of higher level languages like C++, Java, and C\#.
...
The core chapters of this thesis described the contents of \autoref{fig:rustygecko:all} in a bottom-up perspective.
