...
\outlineref{chap:intro} introduces and gives motivation for using {\rust} in a bare-metal system.
...
Further, the existing hardware platform, EFM32, and software libraries used for developing bare-metal applications are presented.

\outlineref{chap:startup} presents what happens in order for a {\rust} program to start executing on the \gls{mcu}.

\outlineref{chap:rel} gives an overview over the {\rust} standard library for bare-metal systems.
