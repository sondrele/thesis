...
In this section we look at how control over the memory layout of objects and static dispatch enables the use of the Object Oriented paradigm in conjunction with \gls{mmio} in embedded programming.
...
\autoref{fig:back:memorymapped} shows a subsection of RAM containing the control register \gls{adc}.
...
This location is, in the case of the {\gecko}, an unmapped memory section used to as padding the previous \gls{mmio}.
