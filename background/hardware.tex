...
In addition to the two mentioned boards, we have also used the Biometrix-EXP Evaluation board.
This board was used to provided additional sensors to the {\tracker} application.
