...
An example of a common slice type in {\rust} is the \keyword{&str} type, which has the representation \code{&[u8]}.
The string type augments the byte slice with UTF-8 encoding.
