...
Lifetime elisions is applied to structures, function definitions, and trait declarations, among
others, in order to tell Rust that the named lifetime is valid in the surrounding scope.
