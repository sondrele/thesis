...
This also tells us that using an unsafe block is not the same as disabling all the checks in the compiler, it is merely a mechanism for the programmer to take responsibility for the safety of part of the program in the cases where the compiler is unable to.
