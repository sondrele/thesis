...
In this respect {\rust} is interesting to consider in an embedded system as it can provide somewhat memory management without the runtime cost of a managed languages.
...
Modern programming languages, like {\Java} and {\lang{Python}}, typically achieves this with a \emph{garbage collector} that runs while the program is being executed with the sole purpose of keeping the memory intact.
