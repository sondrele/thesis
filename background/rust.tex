...
The body of the function contains a macro\footnote{Macros are distigiushed from functions by the leading \code{!} symbol.} invocation of the macro \code{println!}.
This macro has the similar functionality as the {\C} \code{printf} function, but verifies the usage of the function at compile time.
