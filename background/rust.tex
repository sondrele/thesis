...
This section starts by describing {\rust}'s {\core} library and its type-system, before moving on to presenting some of the language features that make {\rust} so different from C.
