...
The \gls{rsl} encompasses the library as a whole, i.e. \lib{collection} is a part of \gls{rsl}.
On the other hand {\std} is just the actual software component, i.e. \lib{collection} is not a part of {\std}, even though it is reexported by {\std}.
