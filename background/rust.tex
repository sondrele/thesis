...
\todo{Sondre: This section might be better suited in Methodology. This is more what we have done, than has been done before this project.}
...
\subsection{Rust Timeline}
\todo{I think it would be nice with a short summary of Rusts development over time, especially from the project start to end.}
...
\subsection{Building and testing (Or Tools?)}
