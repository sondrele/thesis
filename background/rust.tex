...
If it holds the value \code{Some} the programmer is guaranteed by {\rust}'s memory safety guarantees, discussed later in this section, that pointer is valid and safe to use.
