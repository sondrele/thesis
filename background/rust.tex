...
\rust achieves this with a concept called \concept{lifetimes}, in which the compiler with the help of \concept{lifetime elisions} or \econceptmph{lifetime specifiers}, can statically resolve any dangling pointers or \concept{use-after-free} issues introduced by the programmer.
