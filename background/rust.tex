...
This is an important distinction, because it allows for any number of 3rd party concurrency libraries to evolve based on the same core principle of ownership, without being dependent on the concurrency idioms that are provided as part of the standard library.
