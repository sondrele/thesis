...
\autoref{tab:back:libs} shows the software stack that are provided with the \texttt{Gecko}, they are presented in the following sections.
...
The different peripherals that comes with ARM's \glspl{cpu} are memory mapped, which means that reading and writing to certain addresses can be used to modify the peripheral's internal registers.
