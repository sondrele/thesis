...
Table \ref{tab:meth:phases} summarizes the phases with the primary goals annotated.
...
Here a tentative project plan was set, given in Figure \ref{fig:meth:initial}
...
The major challenges identified in the initial meeting with Silicon Labs are given in Figure \ref{fig:meth:challenges}
...
These challenges and their relation to the project are described in Section \ref{} \todo{Write this section in implementation chapter.}
...
The latter was chosen as the starting point and is described in Section \ref{} \todo{Add to Implementation chapter}
...
As described in \ref{} \todo{Background section on emlib design} the libraries to bind to expose their interfaces either as static utility functions or object oriented-like interfaces.
Table \ref{tab:meth:lib} describes the initial modules developed with a description of their interaface and rational for chosing to develop the module.
...
Two complementary projects was specified given in Table \ref{tab:meth:projects}.
...
A full specification of Project I is included in Appendix \ref{app:project:i}.
...
A full specification of Project II is included in Appendix \ref{app:project:ii}
...
About
 - why link to c vs only rust/zinc.rs
 - ffi
